document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        ...
        en: {
            'logo_alt': 'Otzhegi Boka',
            'nav_home': 'Home',
            'nav_rooms': 'Rooms',
            'nav_booking': 'Booking',
            'nav_contacts': 'Contacts',
            'footer_copyright': '© 2026 Hotel "Otzhegi Boka". All rights reserved.',
            ...
            'feature_1_text': 'Faster than you can say "Otzhegi boka". Even if you arrive at 3 am after a wild party — we are already there with a smile.',
